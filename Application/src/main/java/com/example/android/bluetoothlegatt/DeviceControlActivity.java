...
public class DeviceControlActivity extends Activity {
    ...
    */
    ...
    public static final int D_RetryTimeOut  = 50;
    ...
    private void clearUI() {
        mGattServicesList.setAdapter((CustomerExpandableListAdapter) null);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mButton_scan = (Button) findViewById(R.id.button_scan);
        mButton_scan.setOnClickListener(listener_scan);
    ...
    Button.OnClickListener listener_scan = new Button.OnClickListener() {
        public void onClick(View v) {
            //mButton_scan.setBackgroundColor(0xFF0000FF);
            //Toast myToast = Toast.makeText(DeviceControlActivity.this, "scan",Toast.LENGTH_LONG);
            //myToast.show() ;
            if(mConnected){
				deviceIndex = 0;
                ...
                deviceScanRetry = D_RetryTimeOut;
                ...
                CustomerExpandableListAdapter sela = new CustomerExpandableListAdapter(
    ...
    private void displayDeviceData(byte[] data) {
		...
		switch(data[9]){
			...
			case D_packetLinkInfo:
                if(deviceScanRetry %3 == 0){
                        mButton_scan.setText("Scanning.  ");
                }else if(deviceScanRetry %3 == 1){
                    mButton_scan.setText("Scanning.. ");
                }else{
                    mButton_scan.setText("Scanning...");
                }
				...
				if((deviceIndex == 0)||(deviceMax == 0)||(deviceMax > 8)){
					...
					if(deviceScanRetry > 0){
						deviceScanRetry--;
                        //Toast myToast = Toast.makeText(DeviceControlActivity.this, "scanning" + Integer.toString(deviceScanRetry),Toast.LENGTH_LONG);
                        //myToast.show() ;
						if(deviceScanRetry == 0){
							characteristicHandler.removeCallbacks(runnableRead);
                            mButton_scan.setText("Scan");
        ...
        CustomerExpandableListAdapter sensorDevice = new CustomerExpandableListAdapter(
                DeviceControlActivity.this,
                device_list,
                R.layout.device_list,
                new String[]{"names"},
        ...
        mGattServicesList.setAdapter((CustomerExpandableListAdapter) null);
        // enqueue
        mGattServicesList.setAdapter(sensorDevice);
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        if(false) {
            CustomerExpandableListAdapter gattServiceAdapter = new CustomerExpandableListAdapter(
                this,
                gattServiceData,
