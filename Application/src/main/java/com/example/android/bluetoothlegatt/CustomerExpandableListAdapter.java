 ...
 */
public class CustomerExpandableListAdapter extends BaseExpandableListAdapter {
     ...
     *            associated with this {@link CustomerExpandableListAdapter} is
     *            running
     ...
     */
    public CustomerExpandableListAdapter(Context context,
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        int[] pic = {
            ...
            R.drawable.ic_uv,
            R.drawable.ic_sound_level,
            R.drawable.ic_carbon_dioxide,
            R.drawable.ic_voc,
            R.drawable.icn_opened,
            R.drawable.icn_magnetic_field,
			0,
			0};
        ImageView img =(ImageView)v.findViewById(R.id.imageChild);
        img.setImageResource(pic[childPosition]);
    ...
    private void bindView(View view, Map<String, ?> data, String[] from, int[] to) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (v != null) {
                ...
                if(from[i].equals("names")) {
                    Spannable span = new SpannableString(v.getText().toString());
                    span.setSpan(new AbsoluteSizeSpan(40), 12, 35, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    span.setSpan(new ForegroundColorSpan(Color.GRAY), 12, 35, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
                    v.setText(span);
                }
            }
        }
